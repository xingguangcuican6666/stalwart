...
// Clean-room AGPL: resolve the domains owned by a tenant so the queue view can
// be scoped to them. Compiled unconditionally for the base multi-tenancy build.
